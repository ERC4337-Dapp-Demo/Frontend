...
class UserOperationService {
    ...
    constructor(privateKey: string, rpcUrl: string = process.env.NEXT_PUBLIC_RPC_URL as string, paymasterUrl: string = process.env.NEXT_PUBLIC_PAYMASTER_URL as string) {
    ...
    async simpleTransfer(to: string, amount: ethers.BigNumber): Promise<any | null> {
